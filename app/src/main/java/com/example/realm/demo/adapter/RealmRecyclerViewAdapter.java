...
package com.example.realm.demo.adapter;
    ...
    private OrderedRealmCollectionChangeListener createListener() {
        return new OrderedRealmCollectionChangeListener() {
            ...
            public void onChange(Object collection, OrderedCollectionChangeSet changeSet) {
                System.out.println("onChange status=" + changeSet.getState() + ",collection=" + collection);
                ...
                System.out.println("getDeletionRanges:" + (null != deletions ? Arrays.toString(deletions) : null));
                ...
                System.out.println("getInsertionRanges:" + (null != insertions ? Arrays.toString(insertions) : null));
                ...
                System.out.println("getChangeRanges:" + (null != modifications ? Arrays.toString(modifications) : null));
